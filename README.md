...
- **Native App Experience**: Standalone display mode, no browser UI
...
4. **Install as PWA** (optional):
   ...
   - On desktop: Look for "Install" button in address bar (Chrome) or app menu
5. **No Dependencies**: Pure vanilla JavaScript - no build tools or packages required
...
- **HTML**: Single-page application with hidden/shown containers, PWA manifest linked
...
- **Web App Manifest**: Defines PWA installation and display properties
...
This app is built around several personal financial principles
